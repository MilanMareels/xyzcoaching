  ...
  return (
    <div className="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-shadow max-w-md flex flex-col overflow-hidden">
      ...
      <div className="p-8 flex flex-col flex-1">
        ...
        <button className="bg-gray-900 hover:bg-gray-800 text-white px-6 py-3 rounded font-semibold transition-colors cursor-pointer whitespace-nowrap mt-auto self-start">Lees Meer</button>
      </div>
    </div>
  );
}
