export const SEOContent = {
  home: {
    ...
    ogType: "website",
    twitterTitle: "Xyzcoaching - Coaching in Ekeren",
    twitterDescription: "Sportcoaching en personal training in Ekeren: triatlon, trailrunning, zwemmen, mountainbike en looptechniek door Yeray Luxem.",
  ...
  serviceDetails: {
    ...
    ogImage: "https://www.xyzcoaching.be/logo.jpg",
    ogType: "website",
    twitterTitle: "Xyzcoaching - Dienstenoverzicht sportcoaching",
    twitterDescription: "Van triatlon tot trailrunning en zwemmen: ontdek alle coachingdiensten van Xyzcoaching door Yeray Luxem in Ekeren.",
    twitterImage: "https://www.xyzcoaching.be/logo.jpg",
  },
};
